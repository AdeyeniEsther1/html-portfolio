...
- How to display text, images, and links  
- How to organize a webpage  
- How frontend development differs from data science  

##  Goals Moving Forward
- Improve the design with CSS  
- Add interactivity with JavaScript  
- Transition into learning React  
- Build a cleaner, more responsive personal portfolio  

##  Feedback
This is my first attempt at building a website, so feedback is welcome!  
Feel free to open an issue or leave a comment. I’m learning and improving as I go.
